...
- [README](../README.md) — local development quick start (v0.5: host + Docker)
...
- [v0.5/prd.md](./plans/v0.5/prd.md) — v0.5 product requirements (implemented)
- [v0.5/trd.md](./plans/v0.5/trd.md) — v0.5 technical design (implemented)
