...
| 9 | Export account JSON | `tests/test_account_privacy.py` | |
| 10 | Delete account (email+password) | `tests/test_account_privacy.py` | v0.5 smoke extension |
...
**v0.5 smoke extension (P6):** row 10 exercised in extended `test_v02_e2e_smoke.py` using a **disposable** user (export then delete, or delete-only subtest).
